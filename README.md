...
```
# Output:
<img width="577" height="222" alt="image" src="https://github.com/user-attachments/assets/49ac5174-da6e-427f-908d-503dad0faab3" />
...
```
# Output:
<img width="492" height="302" alt="image" src="https://github.com/user-attachments/assets/f9bb37a0-b441-43b6-ba18-a01b8ffc315e" />
...
```
# Output:
<img width="507" height="667" alt="image" src="https://github.com/user-attachments/assets/084c6f04-56c4-447c-99cc-ff834b1b7c3b" />
...
void findAge(struct date *d)
{
    ...
    if (d->c_date < d->b_date)
    {
        ...
        d->c_date = d->c_date + month[d->c_month - 1];
    }

    if (d->c_month < d->b_month)
    {
        d->c_year--;
...
```
# Output:
<img width="628" height="241" alt="image" src="https://github.com/user-attachments/assets/f1474efa-0654-47e6-af9e-c63a6905588d" />
...
```
# Output:
<img width="513" height="276" alt="image" src="https://github.com/user-attachments/assets/d204ea3e-1c19-4f36-a3f9-89efb384b334" />
